...
export class GeoRectGoogle implements Types.GeoRectImplementation {
  ...
  public static create(data: Types.GeoBounds, context: Types.RectContext): GeoRectGoogle {
    return new GeoRectGoogle(data, context);
  }

  public static from(bounds: google.maps.LatLngBounds, context: Types.RectContext): GeoRectGoogle {
