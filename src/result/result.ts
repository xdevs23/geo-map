...
export const createFailure = Mobx.action(
  (error: Error): Types.FailureResult => {
    return Mobx.observable({
...
export const toFailure = Mobx.action(
  (result: Types.Result<any>, error: Error): Types.FailureResult => {
...
export const toSuccess = Mobx.action(
  <T>(result: Types.Result<any>, payload: T): Types.SuccessResult<T> => {
...
export const toQueued = Mobx.action(
  (result: Types.Result<any>): Types.QueuedResult => {
